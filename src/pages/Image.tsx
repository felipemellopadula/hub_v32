...
const SEEDREAM_QUALITY_SETTINGS = [
    ...
    { id: "1:1-3k", label: "1:1 (3K / Square)", width: 3072, height: 3072, steps: 15 },
    { id: "4:3-2k", label: "4:3 (2K / Landscape)", width: 2304, height: 1728, steps: 15 },
    { id: "4:3-3k", label: "4:3 (3K / Landscape)", width: 3072, height: 2304, steps: 15 },
    { id: "16:9-2k", label: "16:9 (2K / Landscape)", width: 2560, height: 1440, steps: 15 },
    { id: "16:9-3k", label: "16:9 (3K / Landscape)", width: 3072, height: 1728, steps: 15 },
    { id: "3:2-2k", label: "3:2 (2K / Landscape)", width: 2496, height: 1664, steps: 15 },
    { id: "3:2-3k", label: "3:2 (3K / Landscape)", width: 3072, height: 2048, steps: 15 },
    { id: "21:9-2k", label: "21:9 (2K / Landscape)", width: 3024, height: 1296, steps: 15 },
    { id: "21:9-3k", label: "21:9 (3K / Landscape)", width: 3072, height: 1314, steps: 15 },
    { id: "3:4-2k", label: "3:4 (2K / Portrait)", width: 1728, height: 2304, steps: 15 },
    { id: "3:4-3k", label: "3:4 (3K / Portrait)", width: 2304, height: 3072, steps: 15 },
    { id: "9:16-2k", label: "9:16 (2K / Portrait)", width: 1440, height: 2560, steps: 15 },
    { id: "9:16-3k", label: "9:16 (3K / Portrait)", width: 1728, height: 3072, steps: 15 },
    { id: "2:3-2k", label: "2:3 (2K / Portrait)", width: 1664, height: 2496, steps: 15 },
    { id: "2:3-3k", label: "2:3 (3K / Portrait)", width: 2048, height: 3072, steps: 15 },
];
