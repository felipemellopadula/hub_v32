    ...
    <div className="prose prose-sm max-w-none dark:prose-invert">
      <ReactMarkdown
        components={{
          ...
          h1({ children }) {
            return <h1 className="text-lg font-bold mb-2 mt-6 first:mt-0">{children}</h1>;
          },
          h2({ children }) {
            return <h2 className="text-lg font-bold mb-2 mt-6 first:mt-0">{children}</h2>;
          },
          h3({ children }) {
            return <h3 className="text-base font-bold mb-2 mt-4 first:mt-0">{children}</h3>;
          },
          ul({ children }) {
            return <ul className="ml-4 mb-4 list-disc space-y-1 [&>li]:pl-1">{children}</ul>;
          },
          ol({ children }) {
            return <ol className="ml-4 mb-4 list-decimal space-y-1 [&>li]:pl-1">{children}</ol>;
          },
          li({ children }) {
